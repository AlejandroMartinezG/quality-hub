-- Fix: restore correct rpc_ncr_list (with LATERAL JOIN + last_message_author_id)
-- and add NOTA filter. Previous migration accidentally used an old version of the function.
