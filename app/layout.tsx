...
const cspContent = [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://api.calidadginez.tech",
    "font-src 'self' data:",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.calidadginez.tech wss://api.calidadginez.tech",
    "frame-src 'none'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
