...
export const PARAMETER_APPLICABILITY: Record<string, { solidos: boolean, ph: boolean }> = {
    ...
    "SHACER": { solidos: true, ph: true }, "SHACLA": { solidos: true, ph: true }, "ALTBRI": { solidos: true, ph: false }, "BRILIQ": { solidos: true, ph: true }, "BRIGEL": { solidos: true, ph: true }, "GINLIQ": { solidos: true, ph: false }, "GINESP": { solidos: true, ph: true }, "DESMOT": { solidos: true, ph: false }, "CERLIQ": { solidos: true, ph: false }, "CREMEC": { solidos: true, ph: false }, "DESIND": { solidos: true, ph: false },
